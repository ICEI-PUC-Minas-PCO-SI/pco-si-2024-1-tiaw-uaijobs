...
const subjects = [
    { name: 'Jurídico', imageUrl: 'Imagens/justica.png' },
    { name: 'Culinária', imageUrl: 'Imagens/culinaria.png' },
    { name: 'Design', imageUrl: 'Imagens/design.png' },
    { name: 'Finanças', imageUrl: 'Imagens/financa.png' },
    { name: 'Fotografia', imageUrl: 'Imagens/fotografia.png' },
    { name: 'Marketing', imageUrl: 'Imagens/marketing.png' },
    { name: 'Redação', imageUrl: 'Imagens/redacao.png' },
    { name: 'Construção', imageUrl: 'Imagens/tijolos.png' },
    { name: 'Tradução', imageUrl: 'Imagens/traducao.png' },
    { name: 'Videoclipes', imageUrl: 'Imagens/videoclipe.png' },
    { name: 'Computação', imageUrl: 'Imagens/computacao.png' },
    { name: 'Mídias Sociais', imageUrl: 'Imagens/midia-social.png' }
];
